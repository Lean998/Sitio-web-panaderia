...
<div class="container mt-5">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-espresso text-light border-0 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 py-1"> Editar Producto</h5>
        </div>
        
        <div class="collapse show" id="collapseAccesos">
            <div class="card-body bg-caramel">
                <form id="editProductoForm" action="{{ route('admin.productos.editar') }}" method="POST" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="nombre" name="nombre" value="{{ old('nombre', $producto->nombre ?? old('nombre')) }}" required class="form-control input-texto bg-sand border-chocolate color-cream @error('nombre') is-invalid @enderror">
                            @error('nombre')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <textarea style="min-height: 200px;" class="form-control input-texto bg-sand border-chocolate color-cream @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="4" required> {{ old('descripcion', $producto->nombre ?? old('descripcion'))  }} </textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @else
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="drop-area-single border-chocolate bg-sand d-flex align-items-center justify-content-center flex-column p-4 @error('imagen') border-danger @enderror" 
                                ...
                                <input type="hidden" name="imagen_actual" id="imagen-actual" value="{{ $producto['imagen'] }}">
                                <small class="text-muted mt-2">Formatos: PNG, JPG, JPEG, WEBP (Max: 2MB)</small>
                            </div>
        
                            <!-- Preview de la nueva imagen -->
                            <div class="preview-imagen mt-2 text-center" id="preview-container" style="display: {{ old('imagen_base64') ? 'block' : 'none' }};">
                                ...
                                <p class="mt-1 mb-0 color-coffee fw-semibold small" id="nombre-archivo">
                                    {{ old('imagen') ?: '' }}
                                </p>
                            </div>
                            @error('imagen')
