...
<div class="container my-4">
    ...
    <div class="d-flex justify-content-center flex-wrap gap-3 mb-4">
        <a role="button" href="{{ route('productos')  }}" class="bg-chocolate color-sand btn btn-aplicar">
            Ver Todos
        </a>
        <a role="button" href="{{ route('productos', ['categoria' => 'panaderia'])  }}" class="bg-chocolate color-sand btn btn-aplicar">
            Panadería
        </a>
        <a role="button" href="{{ route('productos', ['categoria' => 'pasteleria'])  }}" class="bg-chocolate color-sand btn btn-aplicar">
            Pastelería
        </a>
        <a role="button" href="{{ route('productos', ['categoria' =>'salados'])  }}" class="bg-chocolate color-sand btn btn-aplicar">
            Salados
        </a>
    </div>
    <!-- Barra de filtros -->
